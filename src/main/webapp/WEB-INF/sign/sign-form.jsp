...
<div class="container px-4 px-lg-5 mt-5">
    ...
    <form method="post" action="/sign/sign-member" id="sign-form">
        ...
        <div>
            이름 : <input class="form-control" type="text" name="name">
        </div>
        <div>
            ...
            <br>
            상세주소 : <input class="form-control" type="text" name="detailAddr" id="detailAddr">
        </div>
        <div class="mt-2">
            <input class="btn btn-primary" id="joinBtn" type="button" value="가입하기">
            <a class="btn btn-primary" href="/login/login-form">뒤로가기</a>
        </div>
    </form>
</div>
